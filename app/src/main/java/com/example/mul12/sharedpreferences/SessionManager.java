...
public class SessionManager {
    ...
    public void createLoginSession2(String nama2, String nim) {
        // menyimpan nama di pref
        editor.putString(KEY_NAMA, nama2);
        // menyimpan email di pref
    ...
    public HashMap<String, String> getUserDetails2() {
        ...
        // nama user
        user2.put(KEY_NAMA, pref.getString(KEY_NAMA, null));
        // user email id
        user2.put(KEY_NIM, pref.getString(KEY_NIM, null));
        // return user
        return user2;
    }
